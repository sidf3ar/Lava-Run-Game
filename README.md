...
<br>
<strong>Can play it on any browser which support JavaScript. Click on the<a href="https://sidf3ar.github.io/Lava-Run-Game/"> <button type="button">Play it Now..!</button></a> to checkout the game.</strong>
<br>
<br>
